...
app = FastAPI(title="Bass Crane Service API")
...
@api_router.get("/")
async def root():
    return {"message": "Bass Crane Service API"}
...
async def create_contact(input: ContactCreate):
    ...
    logger.info("New contact submission from %s %s <%s>", submission.first_name, submission.last_name, submission.email)
    return submission
